...
Lisp, Haskell, Erlang, ML, F#, Scala ... ¡todos son bienvenidos aquí! ... Bueno, casi todos :-P
...
|13:00   | | |14:00  | | |Introducción a Matematica (por @lux_spes)
|14:00   | | |15:00  | | |Comida
...
La cita es el próximo 15 de Febrero del 2014 en Uny-II.
...
1. Resolver en un lenguaje o estilo funcional uno de los [dos problemas](./Problems.html) 
que hemos planteado y que estés dispuesto a platicarnos tu solución (código) en 
un espacio de 25 minutos.

2. Registrarte [aquí](http://www.eventbrite.com/e/lambda-lounge-mx-tickets-10150543549)
...
### Factoid
Éste sitio fue creado en el estilo de 
